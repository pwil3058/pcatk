...
class ColourSampleMatcher(gtk.VBox):
    ...
    class HueClockwiseButton(gtkpwx.ColouredButton):
        ...
        def set_colour(self, colour):
            ...
            if options.get('colour_wheel', 'red_to_yellow_clockwise'):
                new_colour = paint.HCVW.rgb_for_hue(hue + ColourSampleMatcher.HUE_DISPLAY_SPAN, value)
            else:
                new_colour = paint.HCVW.rgb_for_hue(hue - ColourSampleMatcher.HUE_DISPLAY_SPAN, value)
    ...
    def __init__(self):
        ...
        # Add anti clockwise hue modification button
        hbox = gtk.HBox()
    ...
    def decr_grayness_cb(self, event):
        # TODO: investigate hue changes during decr greyness
        new_colour = list(self.colour.rgb)
        if self.colour.hue is None:
    ...
    def incr_value_cb(self, button):
        ...
        if self.colour.rgb[io[0]] == paint.HCVW.ONE:
            ...
            new_colour = paint.HCVW.rgb_for_hue(self.colour.hue, new_value)
        elif ncomps == 3:
            ...
            if ncomps == 1:
                ...
                # denom should help maintain the hue
                for i in io[:2]:
